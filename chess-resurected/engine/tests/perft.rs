...
fn perft_startpos_d1() {
    assert_eq!(perft(chess_resurected_engine::STARTPOS_FEN, 1), 20);
}

#[test]
fn perft_startpos_d2() {
    assert_eq!(perft(chess_resurected_engine::STARTPOS_FEN, 2), 400);
}

#[test]
fn perft_startpos_d3() {
    assert_eq!(perft(chess_resurected_engine::STARTPOS_FEN, 3), 8902);
}

#[test]
fn perft_startpos_d4() {
    assert_eq!(perft(chess_resurected_engine::STARTPOS_FEN, 4), 197281);
}
